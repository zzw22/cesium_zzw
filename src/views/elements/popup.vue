...
<template>
  <div class="demo_panel">
    <h3 class="demo_title">Popup 点击示例</h3>
  </div>
    ...
    if (
      ...
      if (entity.properties) {
        popupInfo.title = entity.properties.title
          ? typeof entity.properties.title.getValue === "function"
            ? entity.properties.title.getValue(currentTime)
            : entity.properties.title
          : "未知";
        popupInfo.content = entity.properties.content
          ? typeof entity.properties.content.getValue === "function"
            ? entity.properties.content.getValue(currentTime)
